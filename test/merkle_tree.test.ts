...
describe("merkle_tree lib, buildTree", () => {
  it(
    "should build a valid tree with 2 leaves",
    async () => {
  ...
  it(
    "should build a valid tree with 4 leaves",
    async () => {
  ...
  it(
    "should throw error for empty leaves",
    async () => {
      try {
        await buildTree([]);
  ...
  it(
    "should throw error for odd number of leaves",
    async () => {
      try {
...
describe("merkle_tree lib, genLeaves", () => {
  it(
    "should generate correct number of leaves from 1 leaf",
    () => {
  ...
  it(
    "should generate correct number of leaves from 2 leaves",
    () => {
      const leaves = [
  ...
  it(
    "should generate correct number of leaves from 3 leaves",
    () => {
      const leaves = [
        "aleo1rhgdu77hgyqd3xjj8ucu3jj9r2krwz6mnzyd80gncr5fxcwlh5rsvzp9px",
        "aleo1s3ws5tra87fjycnjrwsjcrnw2qxr8jfqqdugnf0xzqqw29q9m5pqem2u4t",
  ...
  it(
    "should generate correct number of leaves from 5 leaves",
    () => {
  ...
  it(
    "should generate correct number of leaves from 9 leaves",
    () => {
  ...
  it(
    "should pad with 0field when needed",
    () => {
      const leaves = ["aleo1rhgdu77hgyqd3xjj8ucu3jj9r2krwz6mnzyd80gncr5fxcwlh5rsvzp9px"];
      const result = genLeaves(leaves);
