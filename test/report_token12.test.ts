...
import { Sealed_report_token_v12Contract } from "../artifacts/js/sealed_report_token_v12";
import { stringToBigInt } from "../lib/Conversion";
import { decryptToken } from "../artifacts/js/leo2js/sealed_report_token_v12";
import { Token } from "../artifacts/js/types/sealed_report_token_v12";
...
const reportTokenContract = new Sealed_report_token_v12Contract({
  mode,
  privateKey: deployerPrivKey,
});
const reportTokenContractForAdmin = new Sealed_report_token_v12Contract({
  mode,
  privateKey: adminPrivKey,
});
const reportTokenContractForAccount = new Sealed_report_token_v12Contract({
  mode,
