...
const compliantTransferContractForAdmin = new Sealed_report_policyContract({ mode, privateKey: adminPrivKey });
const compliantTransferContractForAccount = new Sealed_report_policyContract({ mode, privateKey: accountPrivKey });
const compliantTransferContractForFreezedAccount = new Sealed_report_policyContract({ mode, privateKey: freezedAccountPrivKey });
