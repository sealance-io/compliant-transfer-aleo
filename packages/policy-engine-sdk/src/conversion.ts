...
/**
 * Converts an ASCII string to a BigInt representation
 * Used for token IDs and other string-based identifiers
 *
 * @param asciiString - The ASCII string to convert
 * @returns BigInt representation of the string
 */
export function stringToBigInt(asciiString: string): bigint {
  let bigIntValue = 0n;
 ...
 * @example
 * ```typescript
 * const fieldStr = "123456789field";
 * const address = convertFieldToAddress(fieldStr);
